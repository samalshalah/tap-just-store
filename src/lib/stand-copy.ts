...
const BY_SLUG: Record<string, Partial<StandCopy>> = {
  ...
  "trustpilot-review-stand": {
    badge: "TRUSTPILOT REVIEW",
    destination: "Trustpilot review",
    destinationPhrase: "your Trustpilot page",
    urlLabel: "Your Trustpilot review link",
    urlPlaceholder: "https://www.trustpilot.com/evaluate/...",
    urlHelp: "Paste the evaluate link from your Trustpilot business account.",
  },
  "bbb-review-stand": {
    badge: "BBB REVIEW",
    destination: "Better Business Bureau review",
    destinationPhrase: "your Better Business Bureau listing",
    urlLabel: "Your BBB review link",
    urlPlaceholder: "https://www.bbb.org/...",
    urlHelp: "Paste the customer review link from your BBB profile.",
  },
  "nextdoor-review-stand": {
    badge: "NEXTDOOR REVIEW",
    destination: "Nextdoor review",
    destinationPhrase: "your Nextdoor page",
    urlLabel: "Your Nextdoor recommendation link",
    urlPlaceholder: "https://nextdoor.com/pages/...",
    urlHelp: "Paste the link to your Nextdoor business page.",
  },
  "yellow-pages-review-stand": {
    badge: "YELLOW PAGES REVIEW",
    destination: "Yellow Pages review",
    destinationPhrase: "your Yellow Pages listing",
    urlLabel: "Your Yellow Pages review link",
    urlPlaceholder: "https://www.yellowpages.com/...",
    urlHelp: "Paste the write-a-review link from your YP listing.",
  },
  "apple-maps-review-stand": {
    badge: "APPLE MAPS REVIEW",
    destination: "Apple Maps review",
    destinationPhrase: "your Apple Maps place card",
    urlLabel: "Your Apple Maps link",
    urlPlaceholder: "https://maps.apple.com/...",
    urlHelp: "Paste the place link from Apple Business Connect.",
  },
  "bing-places-review-stand": {
    badge: "BING PLACES REVIEW",
    destination: "Bing Places review",
    destinationPhrase: "your Bing Places listing",
    urlLabel: "Your Bing Places link",
    urlPlaceholder: "https://www.bing.com/maps?...",
    urlHelp: "Paste the listing link from your Bing Places account.",
  },
  "opentable-review-stand": {
    badge: "OPENTABLE REVIEW",
    destination: "OpenTable review",
    destinationPhrase: "your OpenTable page",
    urlLabel: "Your OpenTable link",
    urlPlaceholder: "https://www.opentable.com/r/...",
    urlHelp: "Paste your restaurant's OpenTable page link.",
  },
  "toast-review-stand": {
    badge: "TOAST REVIEW",
    destination: "Toast review",
    destinationPhrase: "your Toast page",
    urlLabel: "Your Toast link",
    urlPlaceholder: "https://www.toasttab.com/...",
    urlHelp: "Paste the link to your Toast ordering or feedback page.",
  },
  "visit-website-stand": {
    badge: "WEBSITE",
    destination: "website",
